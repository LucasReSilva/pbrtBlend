...
'''
    ...
    stage('Export file') {
      steps {
        sh 'wget "https://github.com/LucasReSilva/Cornell-Box/raw/master/Blender%20files/Cycles.blend" && /home/lucas/Documentos/TCC/blender-2.79-linux-glibc219-x86_64/blender -b Cycles.blend -f 1 -E CYCLES'
      }
    }
  }
}