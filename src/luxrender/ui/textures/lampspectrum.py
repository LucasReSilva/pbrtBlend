...
lampspectrum_tree = [
        ...
        ("Metal Halide", [
            ...
            ("GE [MVR325IUWM 325 Watt I-Line Multi-Vapor Metal Halide - Clear Watt Miser] MH Lamp with Mercury, Sodium and Scandium iodides", 30),
        ...
        ("Glow Discharge", [
            ...
            ("Self-ballasted High Pressure Mercury Vapor Lamp, with yttrium vanadate phosphate fluorescent phosphors, in glow discharge mode", 50)
        ] ),
        ("Molecular", [
            ("Butane Gas Flame", 51),
            ("Alcohol Flame", 52)
...
class lampspectrum(bpy.types.IDPropertyGroup):
