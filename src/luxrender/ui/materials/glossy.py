...
class ui_material_glossy(pbrtv3_material_sub):
    bl_label = 'PBRTv3 Glossy Material'

    LUX_COMPAT = {'glossy'}

    display_property_groups = [
        ( ('material', 'pbrtv3_material'), 'pbrtv3_mat_glossy' )
    ]
    ...
    def draw_ior_menu(self, context):
        ...
        lmg = context.material.pbrtv3_material.pbrtv3_mat_glossy
