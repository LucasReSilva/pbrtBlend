...
class luxcore_material(declarative_property_group):
	...
	visibility = {
		...
		'emission_samples':		{ ScenePrefix() + 'luxcore_enginesettings.renderengine_type': O(['BIASPATHCPU', 'BIASPATHOCL']) },
	...
	properties = [
		...
		},
		{
			...
			'attr': 'samples',
			'name': 'Samples',
			'description': 'Material semples count (-1 = global default, size x size)',
			'default': -1,
			'min': -1,
			'max': 256,
		},
