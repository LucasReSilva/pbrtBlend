    ...
    def __convert_volume(self):
        ...
        try:
            ...
            if volume.fresnel_usefresneltexture:
                ior_val = convert_texture_channel(volume, 'fresnel', 'fresnel')
            else:
            ...
            if volume.type == 'clear':
                if volume.absorption_usecolortexture:
                    abs_col = convert_texture_channel(volume, 'absorption', 'color')
                else:
                ...
                if volume.sigma_a_usecolortexture:
                    abs_col = convert_texture_channel(volume, 'sigma_a', 'color')
                else:
            ...
            if volume.type in ['homogeneous', 'heterogeneous']:
                ...
                if volume.sigma_s_usecolortexture:
                    s_source = convert_texture_channel(volume, 'sigma_s', 'color')
