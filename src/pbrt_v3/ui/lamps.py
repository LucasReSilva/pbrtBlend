...
class ui_pbrtv3_lamp_area(lamps_panel):
    ...
    def draw(self, context):
        if context.lamp is not None:
            wide_ui = context.region.width > narrowui
            pbrtv3_lamp = context.lamp.pbrtv3_lamp
            pbrtv3_lamp_area = pbrtv3_lamp.pbrtv3_lamp_area
            is_laser = pbrtv3_lamp.pbrtv3_lamp_laser.is_laser
            ...
            if context.lamp.type == 'AREA':
                ...
                if pbrtv3_lamp_area.opacity_floatvalue != 1 or pbrtv3_lamp_area.opacity_usefloattexture:
                    if is_laser:
...
@PBRTv3Addon.addon_register_class
class ui_pbrtv3core_lamp(lamps_panel):
    """
    ...
    display_property_groups = [
        ( ('lamp', 'pbrtv3_lamp' ), 'pbrtv3core_lamp', lambda: UsePBRTv3Core() )
    ]
