...
class RenderingServerInfo(object):
    """
    Emulate pypbrtv3.RenderingServerInfo
    """
    name = None
    port = None
...
class Custom_Context(object):
    """
    Imitate the real pypbrtv3 Context object so that we can
    ...
    def _api(self, identifier, args=[], file=None):
        ...
        Make a standard pypbrtv3.Context API call. In this case
    ...
    # Wrapped pypbrtv3.Context API calls follow ...
    ...
    # Emulate networking options to pass to real pypbrtv3 context in parse()
    ...
    def parse(self, filename, async):
        ...
        if PYLUX_AVAILABLE:
            from ..outputs.pure_api import Custom_Context as Pypbrtv3_Context

            c = Pypbrtv3_Context(self.context_name)
            ...
            raise Exception('This method requires pypbrtv3')
