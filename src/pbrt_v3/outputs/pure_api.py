...
if not 'PYLUX_AVAILABLE' in locals():
    # If pypbrtv3 is not available, revert to 0.8 feature set
    PBRTv3_VERSION = '0.8'

    try:
        pypbrtv3 = import_bindings_module('pypbrtv3')
        PBRTv3_VERSION = pypbrtv3.version()

        class Custom_Context(pypbrtv3.Context):
            """
            This is the 'pure' entry point to the pypbrtv3.Context API
            ...
            def attributeBegin(self, comment='', file=None):
                ...
                pypbrtv3.Context.attributeBegin(self)
            ...
            def transformBegin(self, comment='', file=None):
                ...
                pypbrtv3.Context.transformBegin(self)
            ...
            def logVerbosity(self, verbosity):
                ...
                try:
                    filterMap = {
                        'verbose': pypbrtv3.ErrorSeverity.LUX_DEBUG,
                        'default': pypbrtv3.ErrorSeverity.LUX_INFO,
                        'quiet': pypbrtv3.ErrorSeverity.LUX_WARNING,
                        'very-quiet': pypbrtv3.ErrorSeverity.LUX_ERROR,
                    }

                    pypbrtv3.errorFilter(filterMap[verbosity])
                except ValueError:
                    pass
        ...
        if PBRTv3_VERSION < '0.8':
            ...
            def getRenderingServersStatus(self):
                ...
                for i in range(self.getServerCount()):
                    rsi = pypbrtv3.RenderingServerInfo()
                    pypbrtv3.Context.getRenderingServersStatus(self, rsi, i + 1)
        ...
        PBRTv3Log('Using pypbrtv3 version %s' % PBRTv3_VERSION)

    except ImportError as err:
        PBRTv3Log('WARNING: Binary pypbrtv3 module not available! Visit '
