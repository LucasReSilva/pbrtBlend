...
from . import warning_pbrtv3core_node, create_pbrtv3core_name
...
class pbrtv3_texture_type_node_add(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        tex1 = self.inputs[0].export_pbrtv3core(properties)
        tex2 = self.inputs[1].export_pbrtv3core(properties)

        set_prop_tex(properties, pbrtv3core_name, 'type', 'add')
        set_prop_tex(properties, pbrtv3core_name, 'texture1', tex1)
        set_prop_tex(properties, pbrtv3core_name, 'texture2', tex2)
...
class pbrtv3_texture_type_node_bump_map(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        input = self.inputs[0].export_pbrtv3core(properties)

        set_prop_tex(properties, pbrtv3core_name, 'type', 'scale')
        set_prop_tex(properties, pbrtv3core_name, 'texture1', input)
        set_prop_tex(properties, pbrtv3core_name, 'texture2', self.calculate_bump_height())
...
class pbrtv3_texture_type_node_mix(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        tex1 = self.inputs[1].export_pbrtv3core(properties)
        tex2 = self.inputs[2].export_pbrtv3core(properties)

        set_prop_tex(properties, pbrtv3core_name, 'type', 'mix')
        set_prop_tex(properties, pbrtv3core_name, 'amount', amount)
        set_prop_tex(properties, pbrtv3core_name, 'texture1', tex1)
        set_prop_tex(properties, pbrtv3core_name, 'texture2', tex2)
...
class pbrtv3_texture_type_node_subtract(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'subtract')
        set_prop_tex(properties, pbrtv3core_name, 'texture1', tex1)
        set_prop_tex(properties, pbrtv3core_name, 'texture2', tex2)
...
class pbrtv3_texture_type_node_colordepth(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        kt = self.inputs[0].export_pbrtv3core(properties)

        set_prop_tex(properties, pbrtv3core_name, 'type', 'colordepth')
        set_prop_tex(properties, pbrtv3core_name, 'depth', self.depth)
        set_prop_tex(properties, pbrtv3core_name, 'kt', kt)
...
class pbrtv3_texture_type_node_math(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        slot_0 = self.inputs[0].export_pbrtv3core(properties)
        slot_1 = self.inputs[1].export_pbrtv3core(properties)
        slot_2 = self.inputs[2].export_pbrtv3core(properties)

        set_prop_tex(properties, pbrtv3core_name, 'type', self.mode)

        if self.mode == 'abs':
            set_prop_tex(properties, pbrtv3core_name, 'texture', slot_0)
        elif self.mode == 'clamp':
            set_prop_tex(properties, pbrtv3core_name, 'texture', slot_0)
            set_prop_tex(properties, pbrtv3core_name, 'min', self.mode_clamp_min)
            set_prop_tex(properties, pbrtv3core_name, 'max', self.mode_clamp_max)
        elif self.mode == 'mix':
            set_prop_tex(properties, pbrtv3core_name, 'amount', slot_0)
            set_prop_tex(properties, pbrtv3core_name, 'texture1', slot_1)
            set_prop_tex(properties, pbrtv3core_name, 'texture2', slot_2)
        else:
            set_prop_tex(properties, pbrtv3core_name, 'texture1', slot_0)
            set_prop_tex(properties, pbrtv3core_name, 'texture2', slot_1)

        if self.clamp_output and self.mode != 'clamp':
            clamp_name = create_pbrtv3core_name(self, suffix='clamp')
            set_prop_tex(properties, clamp_name, 'type', 'clamp')
            set_prop_tex(properties, clamp_name, 'texture', pbrtv3core_name)
            set_prop_tex(properties, clamp_name, 'min', 0)
            set_prop_tex(properties, clamp_name, 'max', 1)
            pbrtv3core_name = clamp_name
...
class pbrtv3_texture_type_node_colormix(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        if self.mode == 'abs':
            set_prop_tex(properties, pbrtv3core_name, 'texture', slot_1)
        elif self.mode == 'clamp':
            set_prop_tex(properties, pbrtv3core_name, 'texture', slot_1)
            set_prop_tex(properties, pbrtv3core_name, 'min', self.mode_clamp_min)
            set_prop_tex(properties, pbrtv3core_name, 'max', self.mode_clamp_max)
        ...
        if slot_0 != 1 and self.mode != 'mix':
            mix_name = create_pbrtv3core_name(self, suffix='mix')
            ...
            set_prop_tex(properties, mix_name, 'texture2', pbrtv3core_name)
            pbrtv3core_name = mix_name
...
class pbrtv3_texture_type_node_colorinvert(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        fac = self.inputs[0].export_pbrtv3core(properties)
        tex = self.inputs[1].export_pbrtv3core(properties)

        set_prop_tex(properties, pbrtv3core_name, 'type', 'subtract')
        set_prop_tex(properties, pbrtv3core_name, 'texture1', [1, 1, 1])
        set_prop_tex(properties, pbrtv3core_name, 'texture2', tex)
...
class pbrtv3_texture_type_node_hsv(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        tex = self.inputs[0].export_pbrtv3core(properties)
        hue = self.inputs[1].export_pbrtv3core(properties)
        sat = self.inputs[2].export_pbrtv3core(properties)
        val = self.inputs[3].export_pbrtv3core(properties)

        set_prop_tex(properties, pbrtv3core_name, 'type', 'hsv')
        set_prop_tex(properties, pbrtv3core_name, 'texture', tex)
        set_prop_tex(properties, pbrtv3core_name, 'hue', hue)
        set_prop_tex(properties, pbrtv3core_name, 'saturation', sat)
        set_prop_tex(properties, pbrtv3core_name, 'value', val)
...
class pbrtv3_texture_type_node_band(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'band')
        set_prop_tex(properties, pbrtv3core_name, 'interpolation', self.interpolation)
        set_prop_tex(properties, pbrtv3core_name, 'amount', amount)

        for index, item in enumerate(self.items):
            set_prop_tex(properties, pbrtv3core_name, 'offset%i' % index, item.offset)
            set_prop_tex(properties, pbrtv3core_name, 'value%i' % index, list(item.value))
...
class pbrtv3_manipulate_3d_mapping_node(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        mapping_type, input_mapping = self.inputs[0].export_pbrtv3core(properties)
...
class pbrtv3_manipulate_2d_mapping_node(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        mapping_type, input_uvscale, input_uvdelta = self.inputs[0].export_pbrtv3core(properties)
