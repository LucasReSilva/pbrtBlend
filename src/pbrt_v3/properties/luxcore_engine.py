...
class pbrtv3core_opencl_devices(declarative_property_group):
    """
...
@PBRTv3Addon.addon_register_class
class pbrtv3core_enginesettings(declarative_property_group):
    """
...
may mute lamps and caustics',
        ...
        {
            'type': 'collection',
            'ptype': pbrtv3core_opencl_devices,
            'attr': 'pbrtv3core_opencl_devices',
            'name': 'OpenCL Devices',
            'items': []
        },
        {
            ...
            'operator': 'pbrtv3render.opencl_device_list_update',
