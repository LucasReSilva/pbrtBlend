...
class pbrtv3core_translatorsettings(declarative_property_group):
    """
    ...
    properties = [
        ...
        },
        {
            ...
            'items': [
                ...
                ('pbrtv3coreui', 'PBRTv3CoreUI', 'Export scene files to output path and render using PBRTv3CoreUI'),
            ],
            'save_in_preset': True
        },
        {
            'type': 'bool',
            'attr': 'run_pbrtv3coreui',
