...
class pbrtv3_volume_data(declarative_property_group):
    ...
    def api_output(self, pbrtv3_context):
        vp = ParamSet()
...
class pbrtv3_volumes(declarative_property_group):
    ...
    properties = [
        ...
        },
        {
            'type': 'operator',
            'attr': 'op_vol_add',
            'operator': 'pbrtv3render.volume_add',
            'text': 'Add',
            'icon': 'ZOOMIN',
        },
        {
            'type': 'operator',
            'attr': 'op_vol_rem',
            'operator': 'pbrtv3render.volume_remove',
            'text': 'Remove',
            'icon': 'ZOOMOUT',
        },
    ]
...
class pbrtv3_lightgroups(declarative_property_group):
    ...
    properties = [
        ...
        },
        {
            'type': 'operator',
            'attr': 'op_lg_add',
            'operator': 'pbrtv3render.lightgroup_add',
        },
        {
            'type': 'bool',
            'attr': 'ignore',
...
class pbrtv3_materialgroups(declarative_property_group):
    ...
    properties = [
        ...
        },
        {
            'type': 'operator',
            'attr': 'op_lg_add',
            'operator': 'pbrtv3render.materialgroup_add',
        },
    ]
...
class pbrtv3_channels(declarative_property_group):
    ...
    visibility = {
        'label_unsupported_engines': {ScenePrefix() + 'pbrtv3core_enginesettings.renderengine_type': O(['BIDIR', 'BIDIRVM'])},
