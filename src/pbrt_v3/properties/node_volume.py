...
import bpy
from ..outputs.pbrtv3core_api import set_prop_vol, set_prop_tex

from ..properties.node_sockets import *
from ..properties.node_material import get_socket_paramsets

from . import (create_pbrtv3core_name_vol, create_pbrtv3core_name, export_emission_pbrtv3core,
               warning_pbrtv3core_node, export_volume_pbrtv3core, pbrtv3_node, pbrtv3_material_node)
...
class pbrtv3_volume_output_node(pbrtv3_node):
    ...
    def export_pbrtv3core(self, volume, properties, blender_scene):
        ...
        if 'Emission Color' in self.inputs:
            emission = self.inputs['Emission Color'].export_pbrtv3core(properties)
        ...
        pbrtv3core_name = export_volume_pbrtv3core(properties, self.inputs[0], volume.name)

        # Set emission color (backwards compatible)
        if emission:
            set_prop_vol(properties, pbrtv3core_name, 'emission', emission)

        set_prop_vol(properties, pbrtv3core_name, 'priority', volume.priority)
...
class pbrtv3_volume_type_node_clear(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, name=None):
        pbrtv3core_name = create_pbrtv3core_name_vol(self, name)

        ior = self.inputs['IOR'].export_pbrtv3core(properties)
        absorption = self.inputs['Absorption Color'].export_pbrtv3core(properties)

        set_prop_vol(properties, pbrtv3core_name, 'type', 'clear')
        set_prop_vol(properties, pbrtv3core_name, 'ior', ior)
        set_prop_vol(properties, pbrtv3core_name, 'absorption', absorption)
...
class pbrtv3_volume_type_node_homogeneous(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, name=None):
        ...
        ior = self.inputs['IOR'].export_pbrtv3core(properties)
        absorption = self.inputs['Absorption Color'].export_pbrtv3core(properties)
        scattering = self.inputs['Scattering Color'].export_pbrtv3core(properties)
        asymmetry = self.inputs['Asymmetry'].export_pbrtv3core(properties)

        if self.inputs['Scattering Scale'] != 1:
            scale = self.inputs['Scattering Scale'].export_pbrtv3core(properties)

            scale_name = create_pbrtv3core_name(self, suffix='scattering_scale')
        ...
        set_prop_vol(properties, pbrtv3core_name, 'type', 'homogeneous')
        set_prop_vol(properties, pbrtv3core_name, 'ior', ior)
        set_prop_vol(properties, pbrtv3core_name, 'absorption', absorption)
        set_prop_vol(properties, pbrtv3core_name, 'scattering', scattering)
        set_prop_vol(properties, pbrtv3core_name, 'asymmetry', asymmetry)
        set_prop_vol(properties, pbrtv3core_name, 'multiscattering', self.use_multiscattering)
...
class pbrtv3_volume_type_node_heterogeneous(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, name=None):
        ...
        set_prop_vol(properties, pbrtv3core_name, 'type', 'heterogeneous')
        set_prop_vol(properties, pbrtv3core_name, 'ior', ior)
        set_prop_vol(properties, pbrtv3core_name, 'absorption', absorption)
        set_prop_vol(properties, pbrtv3core_name, 'scattering', scattering)
        set_prop_vol(properties, pbrtv3core_name, 'asymmetry', asymmetry)
        set_prop_vol(properties, pbrtv3core_name, 'multiscattering', self.use_multiscattering)
        set_prop_vol(properties, pbrtv3core_name, 'steps.size', self.stepsize)
        set_prop_vol(properties, pbrtv3core_name, 'steps.maxcount', self.max_steps)
