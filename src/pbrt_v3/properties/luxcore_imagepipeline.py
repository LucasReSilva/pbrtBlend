...
# See pbrtv3/core/cameraresponse.cpp to keep this up to date
...
class IMAGEPIPELINE_OT_set_pbrtv3_crf(bpy.types.Operator):
    ...
    def poll(cls, context):
        ...
        return camera_data.pbrtv3_camera and camera_data.pbrtv3_camera.pbrtv3core_imagepipeline

    def execute(self, context):
        camera_data = context.camera if hasattr(context, 'camera') else context.scene.camera.data
        camera_data.pbrtv3_camera.pbrtv3core_imagepipeline.crf_preset = self.properties.preset_name
...
@PBRTv3Addon.addon_register_class
class pbrtv3core_imagepipeline(declarative_property_group):
    """
    ...
    properties = [
        ...
        },
        {
            ...
            'attr': 'contour_range',
            'name': 'Range',
            'description': 'Max range of irradiance values (unit: pbrtv3), minimum is always 0',
            'default': 100.0,
            'min': 0.0,
            'soft_min': 0.0,
            'soft_max': 1000.0
