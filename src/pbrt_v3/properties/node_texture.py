...
from . import create_pbrtv3core_name, warning_pbrtv3core_node, warning_classic_node
...
from ..outputs.pbrtv3core_api import UsePBRTv3Core, set_prop_tex
...
class pbrtv3_texture_type_node_blender_blend(pbrtv3_texture_node):
    ...
    pbrtv3core_direction_items = [
        ('horizontal', 'Horizontal', 'Direction: -x to x'),
        ('vertical', 'Vertical', 'Direction: -y to y')
    ]
    pbrtv3core_direction = bpy.props.EnumProperty(name='Direction', items=pbrtv3core_direction_items)

    pbrtv3core_progression_type_map = {
        'lin': 'linear',
        'quad': 'quadratic',
        'ease': 'easing',
        'diag': 'diagonal',
    ...
    def draw_buttons(self, context, layout):
        if UsePBRTv3Core():
            layout.prop(self, 'pbrtv3core_direction', expand=True)
        else:
    ...
    def export_pbrtv3core(self, properties):
        pbrtv3core_name = create_pbrtv3core_name(self)

        set_prop_tex(properties, pbrtv3core_name, 'type', 'blender_blend')
        set_prop_tex(properties, pbrtv3core_name, 'progressiontype', self.pbrtv3core_progression_type_map[self.type])
        set_prop_tex(properties, pbrtv3core_name, 'direction', self.pbrtv3core_direction)
        set_prop_tex(properties, pbrtv3core_name, 'bright', self.bright)
        set_prop_tex(properties, pbrtv3core_name, 'contrast', self.contrast)

        mapping_type, mapping_transformation = self.inputs[0].export_pbrtv3core(properties)
        mapping_transformation = matrix_to_list(mapping_transformation, apply_worldscale=True, invert=True)

        set_prop_tex(properties, pbrtv3core_name, 'mapping.type', mapping_type)
        set_prop_tex(properties, pbrtv3core_name, 'mapping.transformation', mapping_transformation)
...
class pbrtv3_texture_type_node_brick(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        brickmodtex = self.inputs[1].export_pbrtv3core(properties)
        bricktex = self.inputs[2].export_pbrtv3core(properties)
        mortartex = self.inputs[3].export_pbrtv3core(properties)

        set_prop_tex(properties, pbrtv3core_name, 'type', 'brick')
        set_prop_tex(properties, pbrtv3core_name, 'brickmodtex', brickmodtex)
        set_prop_tex(properties, pbrtv3core_name, 'bricktex', bricktex)
        set_prop_tex(properties, pbrtv3core_name, 'mortartex', mortartex)
        set_prop_tex(properties, pbrtv3core_name, 'brickwidth', self.width)
        set_prop_tex(properties, pbrtv3core_name, 'brickheight', self.height)
        set_prop_tex(properties, pbrtv3core_name, 'brickdepth', self.depth)
        set_prop_tex(properties, pbrtv3core_name, 'mortarsize', self.mortarsize)
        set_prop_tex(properties, pbrtv3core_name, 'brickrun', self.brickrun)
        #set_prop_tex(properties, pbrtv3core_name, 'brickbevel', self.brickbevel) # no idea what this does
        set_prop_tex(properties, pbrtv3core_name, 'brickbond', self.brickbond)
...
class pbrtv3_texture_type_node_checker(pbrtv3_texture_node):
    ...
    def draw_buttons(self, context, layout):
        warning_pbrtv3core_node(layout)
        layout.prop(self, 'dimension', expand=True)

    def export_pbrtv3core(self, properties):
        pbrtv3core_name = create_pbrtv3core_name(self)

        texture1 = self.inputs['Color 1'].export_pbrtv3core(properties)
        texture2 = self.inputs['Color 2'].export_pbrtv3core(properties)

        set_prop_tex(properties, pbrtv3core_name, 'type', self.dimension)
        set_prop_tex(properties, pbrtv3core_name, 'texture1', texture1)
        set_prop_tex(properties, pbrtv3core_name, 'texture2', texture2)

        if self.dimension.endswith('2d'):
            mapping_type, uvscale, uvdelta = self.inputs[mapping_2d_socketname].export_pbrtv3core(properties)

            set_prop_tex(properties, pbrtv3core_name, 'mapping.type', mapping_type)
            set_prop_tex(properties, pbrtv3core_name, 'mapping.uvscale', uvscale)
            set_prop_tex(properties, pbrtv3core_name, 'mapping.uvdelta', uvdelta)
        else:
            mapping_type, mapping_transformation = self.inputs[mapping_3d_socketname].export_pbrtv3core(properties)
            mapping_transformation = matrix_to_list(mapping_transformation, apply_worldscale=True, invert=True)
...
class pbrtv3_texture_type_node_blender_clouds(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'blender_clouds')
        set_prop_tex(properties, pbrtv3core_name, 'noisetype', self.noisetype)
        set_prop_tex(properties, pbrtv3core_name, 'noisebasis', self.noisebasis)
        set_prop_tex(properties, pbrtv3core_name, 'noisesize', self.noisesize)
        set_prop_tex(properties, pbrtv3core_name, 'noisedepth', self.noisedepth)
        set_prop_tex(properties, pbrtv3core_name, 'bright', self.bright)
        set_prop_tex(properties, pbrtv3core_name, 'contrast', self.contrast)
...
class pbrtv3_texture_type_node_blender_distortednoise(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'blender_distortednoise')
        set_prop_tex(properties, pbrtv3core_name, 'noise_distortion', self.type)
        set_prop_tex(properties, pbrtv3core_name, 'noisebasis', self.noisebasis)
        set_prop_tex(properties, pbrtv3core_name, 'noisesize', self.noisesize)
        set_prop_tex(properties, pbrtv3core_name, 'distortion', self.distamount)
...
class pbrtv3_texture_type_node_fbm(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'fbm')
        set_prop_tex(properties, pbrtv3core_name, 'octaves', self.octaves)
        set_prop_tex(properties, pbrtv3core_name, 'roughness', self.roughness)
...
class pbrtv3_texture_type_node_image_map(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'imagemap')
        set_prop_tex(properties, pbrtv3core_name, 'file', file_path)
        set_prop_tex(properties, pbrtv3core_name, 'gamma', self.gamma)
        set_prop_tex(properties, pbrtv3core_name, 'gain', self.gain)

        mapping_type, uvscale, uvdelta = self.inputs[0].export_pbrtv3core(properties)
...
class PBRTv3_OT_open_image_wrapper(bpy.types.Operator):
    ...
    """
    bl_idname = "pbrtv3render.open_image_wrapper"
    bl_label = "Open Image"
...
class pbrtv3_texture_type_node_blender_image_map(pbrtv3_texture_node):
    ...
    def generate_preview(self, context):
        ...
        if pbrtv3core_name not in preview_collections:
            collection = bpy.utils.previews.new()
            collection.previews = ()
            collection.image_name = ''
            preview_collections[pbrtv3core_name] = collection

        enum_items = []

        # Get the preview collection
        collection = preview_collections[pbrtv3core_name]
    ...
    def load_image(self, context):
        ...
        bpy.ops.pbrtv3render.open_image_wrapper('INVOKE_DEFAULT')
    ...
    def draw_buttons(self, context, layout):
        ...
        if self.source == 'blender_image':
            ...
            show_previews = context.scene.pbrtv3core_global.nodeeditor_show_imagemap_previews
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'imagemap')
        set_prop_tex(properties, pbrtv3core_name, 'file', file_path)
        set_prop_tex(properties, pbrtv3core_name, 'gamma', gamma)
        set_prop_tex(properties, pbrtv3core_name, 'gain', self.gain)
        ...
        set_prop_tex(properties, pbrtv3core_name, 'channel', self.channel)

        if self.is_normal_map:
            # Implicitly create a normalmap
            normalmap_name = create_pbrtv3core_name(self, suffix='normal')
            set_prop_tex(properties, normalmap_name, 'type', 'normalmap')
            set_prop_tex(properties, normalmap_name, 'texture', pbrtv3core_name)
            set_prop_tex(properties, normalmap_name, 'scale', self.normalmap_scale)
            pbrtv3core_name = normalmap_name
...
class pbrtv3_texture_type_node_blender_marble(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'blender_marble')
        set_prop_tex(properties, pbrtv3core_name, 'marbletype', self.type)
        set_prop_tex(properties, pbrtv3core_name, 'turbulence', self.turbulence)
        set_prop_tex(properties, pbrtv3core_name, 'noisebasis', self.noisebasis)
        set_prop_tex(properties, pbrtv3core_name, 'noisebasis2', self.noisebasis2)
        set_prop_tex(properties, pbrtv3core_name, 'noisedepth', self.noisedepth)
        set_prop_tex(properties, pbrtv3core_name, 'noisesize', self.noisesize)
        set_prop_tex(properties, pbrtv3core_name, 'noisetype', self.noisetype)
        set_prop_tex(properties, pbrtv3core_name, 'turbulence', self.turbulence)
...
class pbrtv3_texture_type_node_blender_musgrave(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'blender_musgrave')
        set_prop_tex(properties, pbrtv3core_name, 'musgravetype', self.musgravetype)
        set_prop_tex(properties, pbrtv3core_name, 'noisebasis', self.noisebasis)
        set_prop_tex(properties, pbrtv3core_name, 'dimension', self.h)
        set_prop_tex(properties, pbrtv3core_name, 'intensity', self.iscale)
        set_prop_tex(properties, pbrtv3core_name, 'lacunarity', self.lacu)
        set_prop_tex(properties, pbrtv3core_name, 'offset', self.offset)
        set_prop_tex(properties, pbrtv3core_name, 'gain', self.gain)
        set_prop_tex(properties, pbrtv3core_name, 'octaves', self.octs)
        set_prop_tex(properties, pbrtv3core_name, 'noisesize', self.noisesize)
        set_prop_tex(properties, pbrtv3core_name, 'bright', self.bright)
        set_prop_tex(properties, pbrtv3core_name, 'contrast', self.contrast)
...
class pbrtv3_texture_type_node_normal_map(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'imagemap')
        set_prop_tex(properties, pbrtv3core_name, 'file', self.filename)
        set_prop_tex(properties, pbrtv3core_name, 'gamma', 1)
...
class pbrtv3_texture_type_node_blender_stucci(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'blender_stucci')
        set_prop_tex(properties, pbrtv3core_name, 'stuccitype', self.type)
        set_prop_tex(properties, pbrtv3core_name, 'noisebasis', self.noisebasis)
        set_prop_tex(properties, pbrtv3core_name, 'noisesize', self.noisesize)
        set_prop_tex(properties, pbrtv3core_name, 'noisetype', self.noisetype)
        set_prop_tex(properties, pbrtv3core_name, 'turbulence', self.turbulence)
...
class pbrtv3_texture_type_node_uv(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'uv')
...
class pbrtv3_texture_type_node_blender_voronoi(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'blender_voronoi')
        set_prop_tex(properties, pbrtv3core_name, 'distmetric', self.distmetric)
        #set_prop_tex(properties, pbrtv3core_name, 'intensity', )
        set_prop_tex(properties, pbrtv3core_name, 'exponent', self.minkowsky_exp)
        set_prop_tex(properties, pbrtv3core_name, 'w1', self.w1)
        set_prop_tex(properties, pbrtv3core_name, 'w2', self.w2)
        set_prop_tex(properties, pbrtv3core_name, 'w3', self.w3)
        set_prop_tex(properties, pbrtv3core_name, 'w4', self.w4)
        set_prop_tex(properties, pbrtv3core_name, 'noisesize', self.noisesize)
        set_prop_tex(properties, pbrtv3core_name, 'bright', self.bright)
        set_prop_tex(properties, pbrtv3core_name, 'contrast', self.contrast)
...
class pbrtv3_texture_type_node_windy(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'windy')
...
class pbrtv3_texture_type_node_blender_wood(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'blender_wood')
        set_prop_tex(properties, pbrtv3core_name, 'woodtype', self.type)
        set_prop_tex(properties, pbrtv3core_name, 'noisebasis', self.noisebasis)
        set_prop_tex(properties, pbrtv3core_name, 'noisebasis2', self.noisebasis2)
        set_prop_tex(properties, pbrtv3core_name, 'noisesize', self.noisesize)
        set_prop_tex(properties, pbrtv3core_name, 'noisetype', self.noisetype)
...
class pbrtv3_texture_type_node_wrinkled(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'wrinkled')
        set_prop_tex(properties, pbrtv3core_name, 'octaves', self.octaves)
        set_prop_tex(properties, pbrtv3core_name, 'roughness', self.roughness)
...
class pbrtv3_texture_type_node_vol_smoke_data(pbrtv3_texture_node):
    ...
    def draw_buttons(self, context, layout):
        engine_settings = context.scene.pbrtv3core_enginesettings
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'densitygrid')
        set_prop_tex(properties, pbrtv3core_name, 'wrap', self.wrap)
        ...
        if SmokeCache.needs_update(PBRTv3Manager.CurrentScene, self.domain, self.source):
            ...
            set_prop_tex(properties, pbrtv3core_name, 'data', grid[3])
            set_prop_tex(properties, pbrtv3core_name, 'nx', int(grid[0]))
            set_prop_tex(properties, pbrtv3core_name, 'ny', int(grid[1]))
            set_prop_tex(properties, pbrtv3core_name, 'nz', int(grid[2]))
...
class pbrtv3_texture_type_node_dots(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        inside = self.inputs[0].export_pbrtv3core(properties)
        outside = self.inputs[1].export_pbrtv3core(properties)

        set_prop_tex(properties, pbrtv3core_name, 'type', 'dots')
        set_prop_tex(properties, pbrtv3core_name, 'inside', inside)
        set_prop_tex(properties, pbrtv3core_name, 'outside', outside)

        mapping_type, uvscale, uvdelta = self.inputs[2].export_pbrtv3core(properties)
...
class pbrtv3_texture_type_node_bilerp(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        texture00 = self.inputs[0].export_pbrtv3core(properties)
        texture01 = self.inputs[1].export_pbrtv3core(properties)
        texture10 = self.inputs[2].export_pbrtv3core(properties)
        texture11 = self.inputs[3].export_pbrtv3core(properties)

        set_prop_tex(properties, pbrtv3core_name, 'type', 'bilerp')
        set_prop_tex(properties, pbrtv3core_name, 'texture00', texture00)
        set_prop_tex(properties, pbrtv3core_name, 'texture01', texture01)
        set_prop_tex(properties, pbrtv3core_name, 'texture10', texture10)
        set_prop_tex(properties, pbrtv3core_name, 'texture11', texture11)
