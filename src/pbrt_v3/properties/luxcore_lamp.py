...
from ..outputs.pbrtv3core_api import ScenePrefix


@PBRTv3Addon.addon_register_class
class pbrtv3core_lamp(declarative_property_group):
    """
    ...
    enabled = {
        'samples': {ScenePrefix() + 'pbrtv3core_enginesettings.renderengine_type': 'TILEPATH'},
        'label_light_visibility': {ScenePrefix() + 'pbrtv3core_enginesettings.renderengine_type': 'TILEPATH'},
        'visibility_indirect_diffuse_enable': {ScenePrefix() + 'pbrtv3core_enginesettings.renderengine_type': 'TILEPATH'},
        'visibility_indirect_glossy_enable': {ScenePrefix() + 'pbrtv3core_enginesettings.renderengine_type': 'TILEPATH'},
        'visibility_indirect_specular_enable': {ScenePrefix() + 'pbrtv3core_enginesettings.renderengine_type': 'TILEPATH'},
    }
