...
class pbrtv3_3d_coordinates_node(pbrtv3_texture_node):
    ...
    def draw_buttons(self, context, layout):
        ...
        if UsePBRTv3Core():
            # PBRTv3Core layout
            if self.coordinates in self.pbrtv3core_mapping_type_map:
                row = layout.row()
    ...
    def export_pbrtv3core(self, properties):
        mapping_type = self.pbrtv3core_mapping_type_map[self.coordinates]
...
class pbrtv3_2d_coordinates_node(pbrtv3_texture_node):
    ...
    def draw_buttons(self, context, layout):
        ...
        if UsePBRTv3Core() and not self.coordinates in self.pbrtv3core_mapping_type_map:
            layout.label(text='Mapping not supported by PBRTv3Core', icon='ERROR')
        else:
...
class pbrtv3_texture_type_node_blackbody(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'blackbody')
        set_prop_tex(properties, pbrtv3core_name, 'temperature', self.temperature)
...
class pbrtv3_texture_type_node_hitpointcolor(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'hitpointcolor')
...
class pbrtv3_texture_type_node_hitpointgrey(pbrtv3_texture_node):
    ...
    channel_pbrtv3core_items = [
        ('-1', 'RGB', 'RGB luminance'),
        ('0', 'R', 'Red luminance'),
        ('1', 'G', 'Green luminance'),
        ('2', 'B', 'Blue luminance'),
    ]
    channel_pbrtv3core = bpy.props.EnumProperty(name='Channel', items=channel_pbrtv3core_items, default='-1')
    ...
    def draw_buttons(self, context, layout):
        if UsePBRTv3Core():
            layout.prop(self, 'channel_pbrtv3core', expand=True)
        else:
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'hitpointgrey')
        set_prop_tex(properties, pbrtv3core_name, 'channel', self.channel_pbrtv3core)
...
class pbrtv3_texture_type_node_pointiness(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        # calculation on the mesh (handled in pbrtv3core object export) and has some nice wrapping to get only part of
        # the pointiness information (see code below)
        pbrtv3core_name = create_pbrtv3core_name(self)

        set_prop_tex(properties, pbrtv3core_name, 'type', 'hitpointalpha')
        ...
        multiplier = self.inputs[0].export_pbrtv3core(properties)

        if multiplier != 1:
            multiplier_name = pbrtv3core_name + '_multiplier'
            set_prop_tex(properties, multiplier_name, 'type', 'scale')
            set_prop_tex(properties, multiplier_name, 'texture1', pbrtv3core_name)
            set_prop_tex(properties, multiplier_name, 'texture2', multiplier)

            pbrtv3core_name = multiplier_name
