...
class pbrtv3core_material(declarative_property_group):
    """
    ...
    visibility = {
        'label_biaspath_only_settings':
            {ScenePrefix() + 'pbrtv3core_enginesettings.renderengine_type': O(['PATH', 'BIDIR', 'BIDIRVM'])},
    }

    enabled = {
        'samples': {ScenePrefix() + 'pbrtv3core_enginesettings.renderengine_type': 'TILEPATH'},
        'label_material_visibility': {
        ScenePrefix() + 'pbrtv3core_enginesettings.renderengine_type': 'TILEPATH'},
        'emission_samples': {
        ScenePrefix() + 'pbrtv3core_enginesettings.renderengine_type': 'TILEPATH'},
    ...
    properties = [
        ...
        },
        {
            ...
            'trg': lambda s, material: material.pbrtv3core_material,
