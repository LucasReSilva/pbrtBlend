...
from ..outputs.pbrtv3core_api import PYpbrtv3core_AVAILABLE, UsePBRTv3Core
...
class pbrtv3_engine(declarative_property_group):
    ...
    visibility = {
        ...
        'monitor_external': {'export_type': 'EXT', 'binary_name': 'pbrtv3render', 'render': True},
        ...
        'min_epsilon': O([A([{'write_files': False}, {'export_type': 'INT'}]), A(
            [O([{'write_files': True}, {'export_type': 'EXT'}]), {'render': True},
             O([{'binary_name': 'pbrtv3render'}, {'binary_name': 'pbrtv3console'}])])]),
    ...
    properties = [
        ...
        },
        {
            ...
            'default': efutil.find_config_value('pbrtv3render', 'defaults', 'auto_start', True),
        },
        {
            'type': 'bool',
        ...
        },
        {
            ...
            'items': [
                         ...
                         ('pbrtv3core', 'PBRTv3Core API (Experimental)', 'Use PBRTv3 v2.x API (experimental and unstable!)',
                          'ERROR', 1)
                     ] if PYpbrtv3core_AVAILABLE else []),
            'save_in_preset': True
        },
        {
            'type': 'bool',
        ...
        },
        {
            ...
            'default': 'pbrtv3render',
            'items': [
                ('pbrtv3render', 'PBRTv3 GUI', 'Render with the PBRTv3 GUI application'),
                ('pbrtv3console', 'LuxConsole', 'Render with LuxConsole and feed the result to the UV/Image Editor'),
                ('pbrtv3vr', 'LuxVR', 'Render with the LuxVR realtime preview tool'),
            ],
            'save_in_preset': True
        },
        {
...
class pbrtv3_networking(declarative_property_group):
    ...
    properties = [
        {  # drawn in panel header
           ...
           'name': 'Use Networking',
           'default': efutil.find_config_value('pbrtv3render', 'defaults', 'use_network_servers', False),
           'save_in_preset': True
        },
        {
            'type': 'string',
            ...
            'default': efutil.find_config_value('pbrtv3render', 'defaults', 'servers', ''),
            'save_in_preset': True
        },
        {
            'type': 'int',
            ...
            'default': int(efutil.find_config_value('pbrtv3render', 'defaults', 'serverinterval', '180')),
            'min': 10,
            'soft_min': 10,
            'save_in_preset': True
        },
