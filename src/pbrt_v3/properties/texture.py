...
def check_texture_variant(self, context, attr, expected_variant):
    ...
    # Disable all alerts due pbrtv3core can handle either variant
    if UsePBRTv3Core():
        return
        ...
        if PBRTv3Manager.GetActive() is not None:
            TC_params.update(
                add_texture_parameter(
                    PBRTv3Manager.GetActive().pbrtv3_context,
                    self.attr,
                    'color',
                    property_group,
...
class TEXTURE_OT_set_pbrtv3_type(bpy.types.Operator):
    ...
    def execute(self, context):
        pbrtv3_tex = context.texture.pbrtv3_texture

        pbrtv3_tex.type = self.properties.tex_name
        pbrtv3_tex.type_label = self.properties.tex_label

        # This is what the user needs in almost all cases
        if pbrtv3_tex.type == 'densitygrid':
            pbrtv3_tex.pbrtv3_tex_transform.coordinates = 'smoke_domain'
...
class pbrtv3_texture(declarative_property_group):
    ...
    def get_paramset(self, scene, texture):
        ...
        if hasattr(self, 'pbrtv3_tex_%s' % self.type):
            pbrtv3_texture = getattr(self, 'pbrtv3_tex_%s' % self.type)
            features, params = pbrtv3_texture.get_paramset(scene, texture)
            ...
            return pbrtv3_texture.variant, params
        else:
            variant, pbrtv3_tex_name, paramset = convert_texture(scene, texture)
...
class pbrtv3_tex_add(declarative_property_group):
    ...
    def get_paramset(self, scene, texture):
        ...
        if PBRTv3Manager.GetActive() is not None:
            add_params.update(
                add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'tex1', self.variant, self)
            )

            add_params.update(
                add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'tex2', self.variant, self)
            )
...
class pbrtv3_tex_band(declarative_property_group):
    ...
    def get_paramset(self, scene, texture):
        ...
        if PBRTv3Manager.GetActive() is not None:
            band_params.update(
                add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'amount', 'float', self)
            )
            ...
            for i in range(1, self.noffsets + 1):
                ...
                band_params.update(
                    add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'tex%d' % i, self.variant, self)
                )
...
class pbrtv3_tex_brick(declarative_property_group):
    ...
    def get_paramset(self, scene, texture):
        ...
        if PBRTv3Manager.GetActive() is not None:
            brick_params.update(
                add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'brickmodtex', self.variant, self)
            )

            brick_params.update(
                add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'bricktex', self.variant, self)
            )

            brick_params.update(
                add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'mortartex', self.variant, self)
            )
    ...
    def get_paramset(self, scene, texture):
        ...
        if PBRTv3Manager.GetActive() is not None:
            colordepth_params.update(
                add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'Kt', 'color', self)
            )
...
class pbrtv3_tex_dots(declarative_property_group):
    ...
    def get_paramset(self, scene, texture):
        ...
        if PBRTv3Manager.GetActive() is not None:
            dots_params.update(
                add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'inside', self.variant, self)
            )
            dots_params.update(
                add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'outside', self.variant, self)
            )
...
class pbrtv3_tex_imagesampling(declarative_property_group):
    ...
    controls = [
        'channel',
        'channel_pbrtv3core',  # PBRTv3Core needs special channel because it needs the extra "rgb" default option
        'gain',
        'gamma',
        'filtertype',
        'discardmipmaps',
    ...
    visibility = {
        ...
        'channel_pbrtv3core': lambda: UsePBRTv3Core(),
...
@PBRTv3Addon.addon_register_class
class pbrtv3_tex_pbrtv3pop(tabulatedfresnel):
    ef_attach_to = ['pbrtv3_texture']
    alert = {}
    ...
    def get_paramset(self, scene, texture):
        ...
        if PBRTv3Manager.GetActive() is not None:
            uvmask_params.update(
                add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'innertex', self.variant, self)
            )
            uvmask_params.update(
                add_texture_parameter(PBRTv3Manager.GetActive().pbrtv3_context, 'outertex', self.variant, self)
            )
...
class pbrtv3_tex_pointiness(declarative_property_group):
    ...
    controls = [
        'curvature_mode',
        'warning_pbrtv3core_tex',
    ]

    visibility = {
        'warning_pbrtv3core_tex': lambda: not UsePBRTv3Core(),
    }
