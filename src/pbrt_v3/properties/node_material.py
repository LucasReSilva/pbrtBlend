...
from . import (create_pbrtv3core_name_mat, create_pbrtv3core_name, warning_classic_node, has_interior_volume,
               export_submat_pbrtv3core, export_emission_pbrtv3core)
from ..export.pbrtv3core.utils import get_elem_key, is_lightgroup_opencl_compatible
from ..export.materials import TextureCounter
from ..export import get_expanded_file_name

from ..outputs.pbrtv3core_api import set_prop_mat, set_prop_vol, set_prop_tex
...
class pbrtv3_texture_maker:
    def __init__(self, pbrtv3_context, root_name):
        def _impl(tex_variant, tex_type, tex_name, tex_params):
            nonlocal pbrtv3_context
            ...
            with TextureCounter(texture_name):
                ...
                ExportedTextures.texture(pbrtv3_context, texture_name, tex_variant, tex_type, tex_params)
                ExportedTextures.export_new(pbrtv3_context)
...
def export_common_sockets(node, properties):
    """
    Call this function in export_pbrtv3core() before setting any properties
    """
    bump = node.inputs['Bump'].export_pbrtv3core(properties) # may be None!

    if 'Opacity' in node.inputs: # Compatibility with old node setups
        transparency = node.inputs['Opacity'].export_pbrtv3core(properties)
    else:
        transparency = 1.0

    return bump, transparency

def set_common_properties(properties, pbrtv3core_name, bump, transparency):
    """
    Call this function in export_pbrtv3core() after setting the properties
    """
    if bump:
        set_prop_mat(properties, pbrtv3core_name, 'bumptex', bump)
        
    if transparency != 1.0:
        set_prop_mat(properties, pbrtv3core_name, 'transparency', transparency)
...
class pbrtv3_material_type_node_carpaint(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        pbrtv3core_name = create_pbrtv3core_name_mat(self, name)

        kd = self.inputs['Diffuse Color'].export_pbrtv3core(properties)
        ks1 = self.inputs['Specular Color 1'].export_pbrtv3core(properties)
        r1 = self.inputs['R1'].export_pbrtv3core(properties)
        m1 = self.inputs['M1'].export_pbrtv3core(properties)
        ks2 = self.inputs['Specular Color 2'].export_pbrtv3core(properties)
        r2 = self.inputs['R2'].export_pbrtv3core(properties)
        m2 = self.inputs['M2'].export_pbrtv3core(properties)
        ks3 = self.inputs['Specular Color 3'].export_pbrtv3core(properties)
        r3 = self.inputs['R3'].export_pbrtv3core(properties)
        m3 = self.inputs['M3'].export_pbrtv3core(properties)

        ka = self.inputs['Absorption Color'].export_pbrtv3core(properties)
        d = self.inputs['Absorption Depth'].export_pbrtv3core(properties)

        bump, transparency = export_common_sockets(self, properties)

        set_prop_mat(properties, pbrtv3core_name, 'type', 'carpaint')

        if self.carpaint_presets == '-':
            # Manual settings
            set_prop_mat(properties, pbrtv3core_name, 'kd', kd)
            set_prop_mat(properties, pbrtv3core_name, 'ks1', ks1)
            set_prop_mat(properties, pbrtv3core_name, 'ks2', ks2)
            set_prop_mat(properties, pbrtv3core_name, 'ks3', ks3)
            set_prop_mat(properties, pbrtv3core_name, 'm1', m1)
            set_prop_mat(properties, pbrtv3core_name, 'm2', m2)
            set_prop_mat(properties, pbrtv3core_name, 'm3', m3)
            set_prop_mat(properties, pbrtv3core_name, 'r1', r1)
            set_prop_mat(properties, pbrtv3core_name, 'r2', r2)
            set_prop_mat(properties, pbrtv3core_name, 'r3', r3)
            set_prop_mat(properties, pbrtv3core_name, 'ka', ka)
            set_prop_mat(properties, pbrtv3core_name, 'd', d)
        else:
            # Preset
            set_prop_mat(properties, pbrtv3core_name, 'preset', self.carpaint_presets)

        set_common_properties(properties, pbrtv3core_name, bump, transparency)

        return pbrtv3core_name
...
class pbrtv3_material_type_node_cloth(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        warp_kd = self.inputs['Warp Diffuse Color'].export_pbrtv3core(properties)
        warp_ks = self.inputs['Warp Specular Color'].export_pbrtv3core(properties)
        weft_kd = self.inputs['Weft Diffuse Color'].export_pbrtv3core(properties)
        weft_ks = self.inputs['Weft Specular Color'].export_pbrtv3core(properties)
        bump, transparency = export_common_sockets(self, properties)

        set_prop_mat(properties, pbrtv3core_name, 'type', 'cloth')
        set_prop_mat(properties, pbrtv3core_name, 'preset', self.fabric_type)
        set_prop_mat(properties, pbrtv3core_name, 'warp_kd', warp_kd)
        set_prop_mat(properties, pbrtv3core_name, 'warp_ks', warp_ks)
        set_prop_mat(properties, pbrtv3core_name, 'weft_kd', weft_kd)
        set_prop_mat(properties, pbrtv3core_name, 'weft_ks', weft_ks)
        set_prop_mat(properties, pbrtv3core_name, 'repeat_u', self.repeat_u)
        set_prop_mat(properties, pbrtv3core_name, 'repeat_v', self.repeat_v)
...
class pbrtv3_material_type_node_glass(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        kt = self.inputs['Transmission Color'].export_pbrtv3core(properties)
        kr = self.inputs['Reflection Color'].export_pbrtv3core(properties)
        ior = self.inputs['IOR'].export_pbrtv3core(properties)

        if self.use_anisotropy:
            u_roughness = self.inputs['U-Roughness'].export_pbrtv3core(properties)
            v_roughness = self.inputs['V-Roughness'].export_pbrtv3core(properties)
        else:
            u_roughness = v_roughness = self.inputs['Roughness'].export_pbrtv3core(properties)

        bump, transparency = export_common_sockets(self, properties)

        set_prop_mat(properties, pbrtv3core_name, 'type', type)
        set_prop_mat(properties, pbrtv3core_name, 'kr', kr)
        set_prop_mat(properties, pbrtv3core_name, 'kt', kt)

        if not (has_interior_volume(self) and self.use_volume_ior):
            set_prop_mat(properties, pbrtv3core_name, 'interiorior', ior)

        if self.rough:
            set_prop_mat(properties, pbrtv3core_name, 'uroughness', u_roughness)
            set_prop_mat(properties, pbrtv3core_name, 'vroughness', v_roughness)
...
class pbrtv3_material_type_node_glossy(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        kd = self.inputs['Diffuse Color'].export_pbrtv3core(properties)
        ks = self.inputs['Specular Color'].export_pbrtv3core(properties)
        u_roughness = self.inputs[6].export_pbrtv3core(properties)
        v_roughness = self.inputs[7].export_pbrtv3core(properties) if self.use_anisotropy else u_roughness
        ka = self.inputs['Absorption Color'].export_pbrtv3core(properties)
        d = self.inputs['Absorption Depth (nm)'].export_pbrtv3core(properties)
        index = self.inputs['IOR'].export_pbrtv3core(properties)
        bump, transparency = export_common_sockets(self, properties)

        set_prop_mat(properties, pbrtv3core_name, 'type', 'glossy2')
        set_prop_mat(properties, pbrtv3core_name, 'kd', kd)
        set_prop_mat(properties, pbrtv3core_name, 'ks', ks)
        set_prop_mat(properties, pbrtv3core_name, 'uroughness', u_roughness)
        set_prop_mat(properties, pbrtv3core_name, 'vroughness', v_roughness)
        set_prop_mat(properties, pbrtv3core_name, 'ka', ka)
        set_prop_mat(properties, pbrtv3core_name, 'd', d)
        set_prop_mat(properties, pbrtv3core_name, 'multibounce', self.multibounce)

        if self.use_ior:
            set_prop_mat(properties, pbrtv3core_name, 'index', index)
...
class pbrtv3_material_type_node_glossycoating(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        base = export_submat_pbrtv3core(properties, self.inputs['Base Material'], pbrtv3core_exporter)
        ks = self.inputs['Specular Color'].export_pbrtv3core(properties)
        u_roughness = self.inputs[5].export_pbrtv3core(properties)
        v_roughness = self.inputs[6].export_pbrtv3core(properties) if self.use_anisotropy else u_roughness
        ka = self.inputs['Absorption Color'].export_pbrtv3core(properties)
        d = self.inputs['Absorption Depth (nm)'].export_pbrtv3core(properties)
        index = self.inputs['IOR'].export_pbrtv3core(properties)
        bump = self.inputs['Bump'].export_pbrtv3core(properties) # May be None

        set_prop_mat(properties, pbrtv3core_name, 'type', 'glossycoating')
        set_prop_mat(properties, pbrtv3core_name, 'base', base)
        set_prop_mat(properties, pbrtv3core_name, 'ks', ks)
        set_prop_mat(properties, pbrtv3core_name, 'uroughness', u_roughness)
        set_prop_mat(properties, pbrtv3core_name, 'vroughness', v_roughness)
        set_prop_mat(properties, pbrtv3core_name, 'ka', ka)
...
class pbrtv3_material_type_node_glossytranslucent(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        index = self.inputs['IOR'].export_pbrtv3core(properties)
        # Back
        ks_bf = self.inputs['BF Specular Color'].export_pbrtv3core(properties) if self.two_sided else ks
        u_roughness_bf = self.inputs[12].export_pbrtv3core(properties) if self.two_sided else u_roughness
        if self.two_sided:
            v_roughness_bf = self.inputs[13].export_pbrtv3core(properties) if self.use_anisotropy_bf else u_roughness_bf
        else:
            v_roughness_bf = v_roughness
        ka_bf = self.inputs['BF Absorption Color'].export_pbrtv3core(properties) if self.two_sided else ka
        d_bf = self.inputs['BF Absorption Depth (nm)'].export_pbrtv3core(properties) if self.two_sided else d
        index_bf = self.inputs['BF IOR'].export_pbrtv3core(properties) if self.two_sided else index

        bump, transparency = export_common_sockets(self, properties)

        set_prop_mat(properties, pbrtv3core_name, 'type', 'glossytranslucent')
        set_prop_mat(properties, pbrtv3core_name, 'kd', kd)
        set_prop_mat(properties, pbrtv3core_name, 'kt', kt)
        ...
        # Back
        set_prop_mat(properties, pbrtv3core_name, 'ks_bf', ks_bf)
        set_prop_mat(properties, pbrtv3core_name, 'uroughness_bf', u_roughness_bf)
        set_prop_mat(properties, pbrtv3core_name, 'vroughness_bf', v_roughness_bf)
        set_prop_mat(properties, pbrtv3core_name, 'ka_bf', ka_bf)
        set_prop_mat(properties, pbrtv3core_name, 'd_bf', d_bf)
        set_prop_mat(properties, pbrtv3core_name, 'multibounce_bf', self.multibounce_bf)

        if self.use_ior_bf:
            set_prop_mat(properties, pbrtv3core_name, 'index_bf', index_bf)
...
class pbrtv3_material_type_node_matte(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        kd = self.inputs[0].export_pbrtv3core(properties)
        sigma = self.inputs[1].export_pbrtv3core(properties)
        bump, transparency = export_common_sockets(self, properties)

        if sigma == 0:
            set_prop_mat(properties, pbrtv3core_name, 'type', 'matte')
        else:
            set_prop_mat(properties, pbrtv3core_name, 'type', 'roughmatte')
            set_prop_mat(properties, pbrtv3core_name, 'sigma', sigma)
...
class pbrtv3_material_type_node_mattetranslucent(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        kr = self.inputs[0].export_pbrtv3core(properties)
        kt = self.inputs[1].export_pbrtv3core(properties)
        sigma = self.inputs[2].export_pbrtv3core(properties)
        bump, transparency = export_common_sockets(self, properties)

        if sigma == 0:
            set_prop_mat(properties, pbrtv3core_name, 'type', 'mattetranslucent')
        else:
            set_prop_mat(properties, pbrtv3core_name, 'type', 'roughmattetranslucent')
            set_prop_mat(properties, pbrtv3core_name, 'sigma', sigma)
...
class pbrtv3_material_type_node_metal2(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        if self.input_type == 'color':
            kr = self.inputs['Color'].export_pbrtv3core(properties)

            # Implicitly create a fresnelcolor texture
            fresnel_texture = create_pbrtv3core_name(self, suffix='fresnelcolor')
            ...
            if self.inputs['Fresnel'].is_linked:
                fresnel_texture = self.inputs['Fresnel'].export_pbrtv3core(properties)
            else:
        ...
        u_roughness = self.inputs[2].export_pbrtv3core(properties)
        v_roughness = self.inputs[3].export_pbrtv3core(properties) if self.use_anisotropy else u_roughness

        bump, transparency = export_common_sockets(self, properties)

        set_prop_mat(properties, pbrtv3core_name, 'type', 'metal2')
        set_prop_mat(properties, pbrtv3core_name, 'uroughness', u_roughness)
        set_prop_mat(properties, pbrtv3core_name, 'vroughness', v_roughness)
        set_prop_mat(properties, pbrtv3core_name, 'fresnel', fresnel_texture)
...
class pbrtv3_material_type_node_mirror(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        set_prop_mat(properties, pbrtv3core_name, 'type', 'mirror')
        set_prop_mat(properties, pbrtv3core_name, 'kr', kr)
...
class pbrtv3_material_type_node_mix(pbrtv3_material_node):
    ...
    def draw_buttons(self, context, layout):
        # OpenCL or CPU?
        enginesettings = context.scene.pbrtv3core_enginesettings
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        amount = self.inputs[0].export_pbrtv3core(properties)
        mat1 = export_submat_pbrtv3core(properties, self.inputs[1], pbrtv3core_exporter)
        mat2 = export_submat_pbrtv3core(properties, self.inputs[2], pbrtv3core_exporter)
        bump, transparency = export_common_sockets(self, properties)

        set_prop_mat(properties, pbrtv3core_name, 'type', 'mix')
        set_prop_mat(properties, pbrtv3core_name, 'amount', amount)
        set_prop_mat(properties, pbrtv3core_name, 'material1', mat1)
        set_prop_mat(properties, pbrtv3core_name, 'material2', mat2)
...
class pbrtv3_material_type_node_null(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        if 'Transmission Color' in self.inputs:
            transparency = self.inputs['Transmission Color'].export_pbrtv3core(properties)
        else:
            transparency = 1.0

        set_prop_mat(properties, pbrtv3core_name, 'type', 'null')
...
class pbrtv3_material_type_node_velvet(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        ...
        kd = self.inputs['Diffuse Color'].export_pbrtv3core(properties)
        thickness = self.inputs['Thickness'].export_pbrtv3core(properties)
        p1 = self.inputs['p1'].export_pbrtv3core(properties)
        p2 = self.inputs['p2'].export_pbrtv3core(properties)
        p3 = self.inputs['p3'].export_pbrtv3core(properties)
        bump, transparency = export_common_sockets(self, properties)

        set_prop_mat(properties, pbrtv3core_name, 'type', 'velvet')
        set_prop_mat(properties, pbrtv3core_name, 'kd', kd)
        set_prop_mat(properties, pbrtv3core_name, 'thickness', thickness)

        if self.advanced:
            set_prop_mat(properties, pbrtv3core_name, 'p1', p1)
            set_prop_mat(properties, pbrtv3core_name, 'p2', p2)
            set_prop_mat(properties, pbrtv3core_name, 'p3', p3)
...
class pbrtv3_light_area_node(pbrtv3_material_node):
    ...
    pbrtv3core_samples = bpy.props.IntProperty(name='Samples', default=-1, min=-1, max=64,
    ...
    def draw_buttons(self, context, layout):
        ...
        if self.advanced:
            ...
            if UsePBRTv3Core():
                layout.prop(self, 'pbrtv3core_samples')
            else:
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, parent_pbrtv3core_name, is_volume_emission=False):
        emission = self.inputs[0].export_pbrtv3core(properties)

        set_prop = set_prop_vol if is_volume_emission else set_prop_mat

        set_prop(properties, parent_pbrtv3core_name, 'emission', emission)
        set_prop(properties, parent_pbrtv3core_name, 'emission.gain', [self.gain] * 3)
        set_prop(properties, parent_pbrtv3core_name, 'emission.power', self.power)
        set_prop(properties, parent_pbrtv3core_name, 'emission.efficency', self.efficacy)
        set_prop(properties, parent_pbrtv3core_name, 'emission.samples', self.pbrtv3core_samples)
        set_prop(properties, parent_pbrtv3core_name, 'emission.theta', math.degrees(self.theta))

        # IES
        iesfile = self.iesname
        iesfile, basename = get_expanded_file_name(self, iesfile)
        if os.path.exists(iesfile):
            set_prop(properties, parent_pbrtv3core_name, 'emission.iesfile', iesfile)

        # Lightgroup
        blender_scene = pbrtv3core_exporter.blender_scene
        lightgroup_id = pbrtv3core_exporter.lightgroup_cache.get_id(self.lightgroup, blender_scene, self)
        is_opencl_compatible = is_lightgroup_opencl_compatible(pbrtv3core_exporter, lightgroup_id)

        if not blender_scene.pbrtv3_lightgroups.ignore and is_opencl_compatible:
            set_prop_mat(properties, parent_pbrtv3core_name, 'emission.id', lightgroup_id)
...
class pbrtv3_material_type_node_datablock(pbrtv3_material_node):
    ...
    def export_pbrtv3core(self, properties, pbrtv3core_exporter, name=None):
        if self.datablock_name in bpy.data.materials:
            ...
            pbrtv3core_exporter.convert_material(mat)
            exporter = pbrtv3core_exporter.material_cache[get_elem_key(mat)]
            pbrtv3core_name = exporter.pbrtv3core_name
        else:
            pbrtv3core_name = create_pbrtv3core_name_mat(self, name)
            set_prop_mat(properties, pbrtv3core_name, 'type', 'matte')
            set_prop_mat(properties, pbrtv3core_name, 'kd', [0, 0, 0])
...
class pbrtv3_material_output_node(pbrtv3_node):
    ...
    def draw_buttons(self, context, layout):
        ...
        if UsePBRTv3Core():
            ...
            if self.advanced:
                ...
                column.enabled = context.scene.pbrtv3core_enginesettings.renderengine_type == 'TILEPATH'
    ...
    def export_pbrtv3core(self, material, properties, blender_scene, pbrtv3core_exporter, pbrtv3core_name):
        # Note: volumes are exported in export/pbrtv3core/materials.py (in "parent" function that calls this function)
        ...
        export_submat_pbrtv3core(properties, self.inputs[0], pbrtv3core_exporter, pbrtv3core_name)

        # Export emission node if attached to this node
        export_emission_pbrtv3core(properties, pbrtv3core_exporter, self.inputs['Emission'], pbrtv3core_name)
        ...
        if materialgroup_name in blender_scene.pbrtv3_materialgroups.materialgroups:
            ...
            set_prop_mat(properties, pbrtv3core_name, 'id', group.id)

            if group.create_MATERIAL_ID_MASK and blender_scene.pbrtv3_channels.enable_aovs:
                pbrtv3core_exporter.config_exporter.convert_channel('MATERIAL_ID_MASK', group.id)
            if group.create_BY_MATERIAL_ID and blender_scene.pbrtv3_channels.enable_aovs:
                pbrtv3core_exporter.config_exporter.convert_channel('BY_MATERIAL_ID', group.id)

        # Export advanced PBRTv3Core material settings
        set_prop_mat(properties, pbrtv3core_name, 'samples', self.samples)
        set_prop_mat(properties, pbrtv3core_name, 'visibility.indirect.diffuse.enable',
                     self.visibility_indirect_diffuse_enable)
        set_prop_mat(properties, pbrtv3core_name, 'visibility.indirect.glossy.enable',
                     self.visibility_indirect_glossy_enable)
        set_prop_mat(properties, pbrtv3core_name, 'visibility.indirect.specular.enable',
                     self.visibility_indirect_specular_enable)

        # Shadow catcher
        set_prop_mat(properties, pbrtv3core_name, 'shadowcatcher.enable', self.is_shadow_catcher)
        set_prop_mat(properties, pbrtv3core_name, 'shadowcatcher.onlyinfinitelights', self.sc_onlyinfinitelights)

        return pbrtv3core_name

    def export(self, scene, pbrtv3_context, material, mode='indirect'):
        ...
        if mode == 'indirect':
            ...
            def make_material_indirect(mat_type, mat_name, mat_params):
                ...
                ExportedMaterials.makeNamedMaterial(pbrtv3_context, material_name, mat_params)
                ExportedMaterials.export_new_named(pbrtv3_context)
            ...
            def make_material_direct(mat_type, mat_name, mat_params):
                nonlocal pbrtv3_context
                pbrtv3_context.material(mat_type, mat_params)
        ...
        make_texture = pbrtv3_texture_maker(pbrtv3_context, tree_name).make_texture
        ...
        def make_volume(vol_name, vol_type, vol_params):
            ...
            if mode == 'indirect':
                if vol_name not in ExportedVolumes.vol_names:  # was not yet exported
                    ...
                    pbrtv3_context.makeNamedVolume(vol_name, vol_type, vol_params)
