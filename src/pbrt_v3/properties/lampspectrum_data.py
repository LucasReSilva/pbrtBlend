...
lampspectrum_tree = [
    ...
    ("High Pressure Mercury", [
        ...
        ("OSRAM [HQL 80W] HPM Lamp with improved warm depbrtv3e color", 19),
    ...
    ("Absorption/Mixed", [
        ("High Pressure Mercury Warm Depbrtv3e light ([1.4.3]) absorbed through blue Cobalt glass", 64),
        ("Incandescent light ([1.2.3]) absorbed through blue Cobalt glass", 65),
        ("High Pressure Mercury Warm Depbrtv3e light ([1.4.3]) absorbed through ciel dye #42053", 66),
        ("Incandescent light ([1.2.3]) absorbed through ciel dye #42053", 67),
        ("High Pressure Mercury Warm Depbrtv3e light ([1.4.3]) absorbed through red glass", 68),
