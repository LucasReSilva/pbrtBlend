...
from ..outputs.pbrtv3core_api import set_prop_tex
...
class pbrtv3_texture_type_node_fresnelcolor(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', 'fresnelcolor')
        set_prop_tex(properties, pbrtv3core_name, 'kr', kr)
...
class pbrtv3_texture_type_node_fresnelname(pbrtv3_texture_node):
    ...
    def export_pbrtv3core(self, properties):
        ...
        if self.frname_preset == 'nk':  # use an NK data file
             ...
             set_prop_tex(properties, pbrtv3core_name, 'type', 'fresnelsopra')
             set_prop_tex(properties, pbrtv3core_name, 'file', full_name)
        else:
             set_prop_tex(properties, pbrtv3core_name, 'type', 'fresnelpreset')
             set_prop_tex(properties, pbrtv3core_name, 'name', self.frname_preset)
...
class pbrtv3_texture_type_node_fresnelfile(pbrtv3_texture_node):
    ...
    type_items = [
        ...
        ('fresnelpbrtv3pop', 'Luxpop', 'NK file with Luxpop format')
    ]
    ...
    def export_pbrtv3core(self, properties):
        ...
        set_prop_tex(properties, pbrtv3core_name, 'type', self.type)
        set_prop_tex(properties, pbrtv3core_name, 'file', full_name)
