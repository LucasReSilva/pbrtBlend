...
class PBRTv3_OT_load_material(bpy.types.Operator):
    bl_idname = 'pbrtv3render.load_material'
...
class PBRTv3_OT_save_material(bpy.types.Operator):
    bl_idname = 'pbrtv3render.save_material'
    ...
    def execute(self, context):
        try:
            ...
            material_context = LM.pbrtv3_context
    ...
    try:
        ...
        if pbrtv3_mat.type in ('matte', 'glossy'):
            if len(Kd_stack) == 1:
                ...
                if variant == 'color':
                    ...
                    pbrtv3mat.Kd_usecolortexture = True
                    pbrtv3mat.Kd_colortexturename = tex.name
                    pbrtv3mat.Kd_color = [i * Kd_stack[0][1] for i in pbrtv3mat.Kd_color]
                    pbrtv3mat.Kd_multiplycolor = True
                else:
                    ...
                    if tex.use_color_ramp:
                        if len(Kd_stack) < 16:
                            ...
                            alpha_tex = alpha_tex_slot.texture = bpy.data.textures.new('Lux::alpha:%s' % tex.name,
                                                                                       'NONE')
                            mix_pbrtv3_tex = mix_tex.pbrtv3_texture
                            pbrtv3_tex = color_tex.pbrtv3_texture
                            alpha_pbrtv3_tex = alpha_tex.pbrtv3_texture

                            col_ramp = tex.color_ramp.elements
                            mix_pbrtv3_tex.type = 'mix'
                            pbrtv3_tex.type = 'band'
                            alpha_pbrtv3_tex.type = 'band'
                            mix_params = mix_pbrtv3_tex.pbrtv3_tex_mix
                            color_params = pbrtv3_tex.pbrtv3_tex_band
                            alpha_params = alpha_pbrtv3_tex.pbrtv3_tex_band
                            ...
                            pbrtv3mat.Kd_usecolortexture = True
                            pbrtv3mat.Kd_colortexturename = mix_tex.name
                    pass
            elif len(Kd_stack) > 1:
                ...
                if (len(Kd_stack) * 3 - 1) < 18:
                    for n in range(len(Kd_stack)):
                        ...
                        if tex.use_color_ramp:
                            ...
                            mix_pbrtv3_tex = mix_tex.pbrtv3_texture
                            color_pbrtv3_tex = color_tex.pbrtv3_texture
                            alpha_pbrtv3_tex = alpha_tex.pbrtv3_texture
                            ...
                            col_ramp = tex.color_ramp.elements
                            mix_pbrtv3_tex.type = 'mix'
                            color_pbrtv3_tex.type = 'band'
                            alpha_pbrtv3_tex.type = 'band'

                            color_params = color_pbrtv3_tex.pbrtv3_tex_band
                            alpha_params = alpha_pbrtv3_tex.pbrtv3_tex_band
                ...
                pass
                # else:
                #pbrtv3mat.Kd_usecolortexture = False
        ...
        if pbrtv3_mat.type in ('glossy'):
            if len(Ks_stack) == 1:
                ...
                if variant == 'color':
                    # assign the texture directly
                    pbrtv3mat.Ks_usecolortexture = True
                    pbrtv3mat.Ks_colortexturename = tex.name
                    pbrtv3mat.Ks_color = [i * Ks_stack[0][1] for i in pbrtv3mat.Ks_color]
                    pbrtv3mat.Ks_multiplycolor = True
                else:
                    # TODO - insert mix texture
                    # check there are enough free empty texture slots !
                    pass
                ...
                pbrtv3mat.Ks_usecolortexture = False
...
class PBRTv3_OT_material_reset(bpy.types.Operator):
    bl_idname = 'pbrtv3render.material_reset'
...
class PBRTv3_OT_convert_all_materials(bpy.types.Operator):
    bl_idname = 'pbrtv3render.convert_all_materials'
...
class PBRTv3_OT_convert_material(bpy.types.Operator):
    bl_idname = 'pbrtv3render.convert_material'
...
class PBRTv3_OT_material_copy(bpy.types.Operator):
    bl_idname = 'pbrtv3render.material_copy'
    bl_label = 'Copy'
