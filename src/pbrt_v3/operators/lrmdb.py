...
class _lrmdb_state(lrmdb_client):
    ...
    def upload(self, context):
        bpy.ops.pbrtv3render.lrmdb_upload()
    ...
    def begin_login(self, context):
        bpy.ops.pbrtv3render.lrmdb_login('INVOKE_DEFAULT')

    def end_login(self, context):
        bpy.ops.pbrtv3render.lrmdb_logout()
        self.reset_actions()
        self._active = False
...
class PBRTv3_OT_lrmdb_login(bpy.types.Operator):
    ...
    bl_idname = 'pbrtv3render.lrmdb_login'
...
class PBRTv3_OT_lrmdb_logout(bpy.types.Operator):
    ...
    bl_idname = 'pbrtv3render.lrmdb_logout'
...
class PBRTv3_OT_upload_material(bpy.types.Operator):
    bl_idname = 'pbrtv3render.lrmdb_upload'
