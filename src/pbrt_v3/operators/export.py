...
class EXPORT_OT_pbrtv3render(bpy.types.Operator):
    bl_idname = 'export.pbrtv3render'
...
menu_func = lambda self, context: self.layout.operator("export.pbrtv3render", text="Export PBRTv3 Scene")
    ...
    def execute(self, context):
        ...
        for obj in selection:
            ...
            if obj.type in ['MESH', 'CURVE', 'SURFACE', 'META', 'FONT']:
                ...
                # rename object
                obj.name = obj.name + '_pbrtv3_proxy'
