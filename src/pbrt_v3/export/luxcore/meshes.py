...
class ExportedShape(object):
    def __init__(self, mesh_definition):
        self.pbrtv3core_object_name = mesh_definition[0]
        self.pbrtv3core_shape_name = 'Mesh-' + self.pbrtv3core_object_name
...
class MeshExporter(object):
    ...
    def convert(self, pbrtv3core_scene):
        ...
        self.__convert_object_geometry(pbrtv3core_scene)

        return self.properties


    def __convert_object_geometry(self, pbrtv3core_scene):
        ...
        pbrtv3core_shape_name = self.__generate_shape_name()
        self.__export_mesh_to_shape(pbrtv3core_shape_name, prepared_mesh, pbrtv3core_scene)
    ...
    def __export_mesh_to_shape(self, name, mesh, pbrtv3core_scene):
        ...
        mesh_definitions = pbrtv3core_scene.DefineBlenderMesh(name, len(mesh.tessfaces), faces, len(mesh.vertices),
