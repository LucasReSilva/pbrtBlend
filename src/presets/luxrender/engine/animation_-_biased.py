...
bpy.context.scene.luxrender_engine.monitor_external = False
...
bpy.context.scene.luxrender_sampler.haltspp = 132
...
bpy.context.scene.luxrender_sampler.pixelsamples = 128
...
bpy.context.scene.luxrender_integrator.causticphotons = 75000
...
bpy.context.scene.luxrender_integrator.nphotonsused = 700
bpy.context.scene.luxrender_integrator.maxphotondist = 0.35
bpy.context.scene.luxrender_integrator.finalgather = True
bpy.context.scene.luxrender_integrator.finalgathersamples = 12
bpy.context.scene.luxrender_integrator.gatherangle = 10
