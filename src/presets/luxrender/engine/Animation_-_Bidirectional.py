...
bpy.context.scene.luxrender_halt.haltspp = 256
bpy.context.scene.luxrender_sampler.pixelsampler = 'tile'
...
bpy.context.scene.luxrender_integrator.eyedepth = 10
bpy.context.scene.luxrender_integrator.lightdepth = 10
