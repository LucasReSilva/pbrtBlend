...
bpy.context.scene.luxrender_sampler.haltspp = 63
...
bpy.context.scene.luxrender_integrator.shadowraycount = 4
...
bpy.context.scene.luxrender_integrator.nphotonsused = 100
bpy.context.scene.luxrender_integrator.maxphotondist = 1.00
