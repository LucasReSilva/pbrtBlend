...
bpy.context.scene.luxrender_integrator.advanced = True
bpy.context.scene.luxrender_integrator.lightstrategy = 'one'
...
bpy.context.scene.luxrender_integrator.maxdepth = 8
bpy.context.scene.luxrender_integrator.shadowraycount = 1
...
bpy.context.scene.luxrender_integrator.maxphotondepth = 10
...
bpy.context.scene.luxrender_integrator.gatherangle = 10.0
...
bpy.context.scene.luxrender_integrator.directlightsampling = True
...
bpy.context.scene.luxrender_integrator.startk = 15
bpy.context.scene.luxrender_integrator.alpha = 0.699999988079071
bpy.context.scene.luxrender_integrator.glossythreshold = 100.0
bpy.context.scene.luxrender_integrator.lookupaccel = 'hybridhashgrid'
bpy.context.scene.luxrender_integrator.pixelsampler = 'vegas'
bpy.context.scene.luxrender_integrator.photonsampler = 'halton'
